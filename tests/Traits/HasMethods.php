...
trait HasMethods
{
    ...
    public function test_controller_has_method_create(): void
    {
        if($this->controllerType === 'api')
            $this->markTestSkipped('this api controller');

        $this->controller_has_method('create');
    }
    ...
    public function test_controller_has_method_edit(): void
    {
        if($this->controllerType === 'api')
            $this->markTestSkipped('this api controller');

        $this->controller_has_method('edit');
    }
