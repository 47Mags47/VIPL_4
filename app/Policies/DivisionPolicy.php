...
class DivisionPolicy
{
    ...
    {
        return $user->hasPermission('division_viewAny');
    }
    ...
    {
        return $user->hasPermission('division_view');
    }
    ...
    {
        return $user->hasPermission('division_create');
    }
    ...
    {
        return $user->hasPermission('division_update');
    }
    ...
    {
        return $user->hasPermission('division_delete');
    }
}
